# qsub -v DATADIR=/data/charlesworth/guppy/analyses/repeatmodeler/47620/ -v SEQFILE=guppy-families.fa -cwd -N DeepTE -V -pe smp 60 -b yes 'bash deepTE.sh'


WORKDIR=/scratch/$USER/DeepTE/$JOB_ID
MY_DATA_DIR=/data/charlesworth/guppy/analyses/temporary/deepTE
  mkdir -p $WORKDIR
